defmodule Mem0.Extractor.Prompt do
  ...
  Plain EEx rather than HEEx on purpose: the output is text for an LLM, and
  HEEx would entity-escape message content (`<`, `&`, quotes), corrupting
  code and command output in the transcript.
  """
